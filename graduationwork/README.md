...
BlueTooth HC-06을 이용한 안드로이드와 블루투스 통신
DHT 11 습도센서를 사용하여 기기 내부의 습도측정 및 일정 이상 습도가 감지되면 옆면의 팬이 동작
android와 firebase를 이용한 로그인 기능 및 커뮤티니 기능
위의 LCD를 통해 내부의 습도를 확인 가능 
UV 소독기를 통한 신발 내부  
